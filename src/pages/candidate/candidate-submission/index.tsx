import useGetAllSubmissionsByClientIdJobId from '@/pages/client/client-details/jobs/submissions/hooks/useGetAllSubmissionsByClientIdJobId'
...
export const CandidateSubmission: FC<SubmissionProps> = ({
  client_id,
  job_id,
}) => {
