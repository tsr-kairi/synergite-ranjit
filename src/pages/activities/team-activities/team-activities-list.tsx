...
interface ITeamActivitiesProps {
  data: TCandidate[]
}

// Exporting Default ClientTable Component
export function TeamActivitiesList({ data }: ITeamActivitiesProps) {
  const { classes } = useStyles()
  ...
  const { mutate: deleteTeamActivities } = useDeleteCandidateById()
  ...
  const openModalForDelete = (TeamActivities: TCandidate) => {
    openConfirmModal({
      ...
      onConfirm: () => {
        deleteTeamActivities(TeamActivities.uuid)
        console.log('delete')
        showNotification({
          title: 'TeamActivities Deleted !!',
          // message: `${Employee.fname} has been deleted successfully.`,
          message: `TeamActivities has been deleted successfully.`,
        })
      },
    })
  }
